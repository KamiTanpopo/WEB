...
(1, ' House of Gucci', 'Ridley Scott', ' Crime, Thriller, Drama', 'USA', '\r\nAdam Driver, Lady Gaga, Jared Leto, Al Pacino.', 157, 7),
(2, ' The dune', 'Denis Villeneuve', 'Adventure, Drama, Science Fiction', 'USA', 'Jason Momoa, Rebecca Ferguson, Timothy Shalame, Josh Brolin, Zendeya, Oscar Isaac', 155, 8.2),
(3, '007: No time to die', 'Carrie Fukunaga', ' Action, Adventure, Thriller', 'USA, Great Britain, Australia', '\r\nDaniel Craig, Lea Seydou, Rami Malek, Rafe Fiennes, Ben Wishow, Naomi Harris, Rory Kinnear', 163, 7.2),
(4, ' Something is wrong with Ron', 'Alessandro Carloni, Jean-Philippe Vine', ' Cartoon, Adventure, Comedy', 'USA, Great Britain, Australia', 'Thomas Barbasca, Bentley Kalu, Ava Morse', 107, 7.5),
(5, 'The king\'s move', 'Philipp Stolzl', ' History, Drama', 'Germany, Austria', '\r\nOliver Mazucci, Albrecht Schuch, Birgit Minichmeier, Samuel Finzi', 110, 7.3),
(6, 'Eternal', 'Chloe Zhao', ' Action, Drama, Fiction, Marvel', 'USA', 'Angelina Jolie, Richard Madden, Kumail Nanjiani, Keith Harrington, Salma Hayek, Brian Tyree Henry, Ma Don Sok, Lauren Ridloff, Leah McHugh', 158, 6.8);
