...
<html lang="en">
    <head>
		...
		/>
		<link rel="stylesheet"
			href="https://cdnjs.cloudflare.com/ajax/libs/unitegallery/1.7.40/themes/default/ug-theme-default.min.css"
		/>
...
<?php }
  ...
  document.getElementById('gray').style.display = state;
            ...
            <div class="header_top" style="height: 100px;">
                <div class="header_text" style="font-size: 30px;">
                    <h2>Найкращі кадри з фільмів</h2>
                </div>
            </div>
                <div id="gallery">
                    <img src="kadr1.png">
